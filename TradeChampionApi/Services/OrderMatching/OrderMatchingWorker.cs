...
//             {
//                 if (!_orderBooks.TryGetValue(order.Symbol, out var book))
//                 {
//                     book = new OrderBook(order.Symbol);
//                     _orderBooks[order.Symbol] = book;
//                 }
...
//             {
//                 _logger.LogInformation($"[OrderBook] {symbol}: BUY={book.GetBuyOrders().Count}, SELL={book.GetSellOrders().Count}");
//             }
//         }
//     }
// }
